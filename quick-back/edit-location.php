...
<?php if(isset($_GET['cate_name'])){
  ...
  $query_id = $getCate[0];
  $selectloc = mysqli_query($conn,"SELECT * FROM `location` WHERE id = '".$query_id."' ");
            ...
            <div class="card-text">
                      ...
                      <form class="form form-horizontal" id="cate-form">
                        <div class="form-body">                         
                            ...
                            <input type="hidden" name="location_id" value="<?= $query_id; ?>">
                            <div class="location_group">
                              <div class="form-group row">
                                <label class="col-md-3 label-control" for="projectinput5">Location</label>
                                  <div class="col-md-7">
                                    <input type="text" id="projectinput5" class="form-control form_cate" placeholder="Location Name" name="location" value="<?= $fetchloc['location_name']; ?>">
                                  </div>
                              </div>
                            </div>
                        </div>
