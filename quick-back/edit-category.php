...
<?php if(isset($_GET['cate_name'])){
  ...
  $query_id = $getCate[0];
  $selectCategory = mysqli_query($conn,"SELECT * FROM `category` WHERE id = '".$query_id."' ");
          ...
          <div class="card">
            ...
            <div class="card-text">
                      ...
                      <form class="form form-horizontal" id="cate-form">
                        <div class="form-body">                         
                            <input type="hidden" name="cate_id" value="<?= $query_id; ?>">
                            ...
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="projectinput5">Category</label>
                                <div class="col-md-9">
                                  <input type="text" id="projectinput5" class="form-control form_cate" placeholder="Category Name" name="category" value="<?php echo $fetchCategory['category_name']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="projectinput9">About Category</label>
                                <div class="col-md-9">
                                  <textarea id="projectinput9" rows="5" class="form-control form_cate" name="about_cate" placeholder="About Category"><?php echo $fetchCategory['category_about']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                  <select name="cate_icon" id="select_d" class="form-control form_cate">
                                    ...
                                    <?php while($fetch_icon =mysqli_fetch_array($select_icon)): ?>
                                      <option value="<?= $fetch_icon['cate_icon'] ?>" <?php if($fetchCategory['category_icon'] == $fetch_icon['cate_icon']){ ?> selected <?php } ?>><?= $fetch_icon['icon_value'] ?></option>
                                    <?php endwhile; ?>
                                  </select>
