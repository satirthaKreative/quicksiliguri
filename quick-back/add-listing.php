            ...
            <div class="card-text">
                      ...
                      <form class="form form-horizontal" id="cate-form">
                        <div class="form-body">                         
                            ...
                            <h4 class="form-section"><i class="ft-clipboard"></i>Listing Details</h4>
                              ...
                              <div class="form-group row">
                                <label class="col-md-3 label-control" for="projectinput5">Business Listing</label>
                                  <div class="col-md-7">
                                    <div class="row">
                                      <div class="col-md-6">
                                        <input type="text" id="projectinput5" class="form-control form_cate" placeholder="business name" name="business_name[]">
                                      </div>
                                      <div class="col-md-5">
                                        <input type="text" id="projectinput5" class="form-control form_cate" placeholder="business contact" name="business_contact[]">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-2">
